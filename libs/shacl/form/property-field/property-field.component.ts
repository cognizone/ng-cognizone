...
import { GraphAndControlLinkingService, GraphFormContextService } from '@cognizone/json-model-graph';
import { manyToArray } from '@cognizone/model-utils';
import { OnDestroy$ } from '@cognizone/ng-core';
import { ShaclHelper, ShaclHelperDefinition, ShPropertyShape } from '../../core';
...
export class PropertyFieldComponent extends OnDestroy$ implements OnInit {
  ...
  addReference(): void {
    ...
    const updatedNodes = wrapper.addReference(
      wrapper.getNodeSnapshot(this.graphFormContextService.nodeUri),
