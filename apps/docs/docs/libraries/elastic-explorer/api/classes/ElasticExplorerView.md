---
id: "ElasticExplorerView"
title: "Class: ElasticExplorerView"
sidebar_label: "ElasticExplorerView"
sidebar_position: 0
...
• **new ElasticExplorerView**(`dialog`, `route`, `elasticExplorerService`, `router`, `loadingService`)
...
| `elasticExplorerService` | `ElasticExplorerService` |
| `router` | `Router` |
...
• `Private` **isDetailsOpened**: `boolean` = `false`
...
OnDestroy$.\_\_@hasInstance@7312
