---
id: "OperationDebug"
title: "Class: OperationDebug"
sidebar_label: "OperationDebug"
sidebar_position: 0
...
• **new OperationDebug**(`renderer`, `dialog`, `operationsService`, `logger`)
...
• `Private` `Optional` **options**: [`OperationDebugOptions`](../interfaces/OperationDebugOptions)
...
▸ `Private` **enableDebug**(`operation`, `path`): `void`

#### Parameters

| Name | Type |
| :------ | :------ |
| `operation` | `Nil`<[`Operation`](../interfaces/Operation)\> |
...
| Name | Type |
| :------ | :------ |
| `options` | [`OperationDebugOptions`](../interfaces/OperationDebugOptions) |
