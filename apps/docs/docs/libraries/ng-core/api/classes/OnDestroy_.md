...
- `__class`<`this`\> & [`OnDestroyMixin`](../modules#ondestroymixin)
...
OnDestroyMixin(class {}).constructor
...
OnDestroyMixin(class {}).onDestroy$
...
OnDestroyMixin(class {}).arguments
...
OnDestroyMixin(class {}).emptySink
...
OnDestroyMixin(class {}).firstUntilDestroyed
...
OnDestroyMixin(class {}).ngOnDestroy
...
OnDestroyMixin(class {}).untilDestroyed
...
OnDestroyMixin(class {}).\_\_@hasInstance@53905
